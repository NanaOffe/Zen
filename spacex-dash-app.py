...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                step = 1000, marks= {0: '0', 2500: '2500', 5000: '5000', 7500: '7500', 10000: '10000'}, value = [min_payload, max_payload]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names='class', title=f'Total Success and Failure Launches for Site {entered_site}')
    return fig
...
def get_scatter_plot(entered_site, payload_slider):
    low, high = payload_slider
       # Debugging: Print the slider values
    print(f"Payload slider range: {low} - {high}")
    # Debugging: Print the slider values
    print(f"Payload slider range: {low} - {high}")
    # Debugging: Print the filtered DataFrame after payload filtering
    print(f"Filtered DataFrame after payload range filtering:\n{filtered_df}")
    ...
    if entered_site == 'ALL':
        ...
        # Debugging: Print the filtered DataFrame after site filtering
        print(f"Filtered DataFrame after site filtering:\n{filtered_df}")
